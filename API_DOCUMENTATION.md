...
- `GET /api/visitors/pre-register/search/:query` - Search pre-registered visitor by ID, `passCode`, `visitorId`, `mobile`, or `fullName` (Alias: `GET /api/visitors/pre-register/:id`).
